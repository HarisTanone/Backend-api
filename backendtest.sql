...
COPY public.logins (id, username, password, created_at, updated_at) FROM stdin;
\.
...
5	2024_10_14_082218_create_logins_table	1
6	2024_10_14_093738_add_remember_token_to_users_table	1
\.
...
COPY public.users (id, name, username, password, created_by, updated_by, created_at, updated_at, deleted_at, remember_token) FROM stdin;
7	Admin	admin	$2y$10$W3oHI97dSpxGanAFWDYCpO9/6rxcazjiPVIv.0ykDeNUeWzSMmHbm	1	1	2024-10-15 01:45:15	2024-10-15 01:45:15	\N	\N
8	Haris Tanone	massharis	$2y$10$Jx8nRpzprr2rUwqUQvW1hOmt7g9t0odnwB3SSdzUx2EU9npwzQGA2	7	7	2024-10-15 01:45:52	2024-10-15 01:45:52	\N	\N
\.
...
--
-- Name: logins logins_username_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--
